...
workflowr::wflow_use_github("LearnUseZone", "workflowrSubfolders")  # choose 1 to create a remote repository automatically -> sign-in in loaded web browser to authenticate; choose 2 when a remote repository is already created
