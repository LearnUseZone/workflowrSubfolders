...
#' \code{generate.rmd} generates Rmd files from original .Rmd files that are saved in subdirectories and save them into directory "analysis".
#' These generated .Rmd files are meant to be temporary and they will be deleted after \code{\link{generate.subdir}} generates final html files.
#'
#' @param dir
